...
describe("A variable", function() {
    ...
    it("should throw an error if initialized with an integer", function() {
        expect(function(){new Variable(5);}).toThrow("Invalid Argument (5): Variable initalizer must be of type String.");
    });

    it("should throw an error if initialized with a float", function() {
        expect(function(){new Variable(5.1);}).toThrow("Invalid Argument (5.1): Variable initalizer must be of type String.");
    });
});
